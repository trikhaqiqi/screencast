...
export default function App(props) {
    ...
    return (
        <div>
            ...
            {/* <div className="mt-5 py-4 bg-light border-top">
                <div className="container">
                    Since 2021 &trade;
                </div>
            </div> */}
            ...
            <section className="h-100 w-100 bg-white" style={{boxSizing: 'border-box'}}>
                ...
                <div className="list-footer">
                    ...
                    <div className="col-lg-3 col-md-6">
                        ...
                        <nav className="list-unstyled">
                            ...
                            <dev href className="list-menu">Home</dev>
                            </li>
                            <li className="list-space">
                            <dev href className="list-menu">About</dev>
                            </li>
                            <li className="list-space">
                            <dev href className="list-menu">Features</dev>
                            </li>
                            <li className="list-space">
                            <dev href className="list-menu">Pricing</dev>
                            </li>
                            <li className="list-space">
                            <dev href className="list-menu">Testimonial</dev>
                            </li>
                            <li className="list-space">
                            <dev href className="list-menu">Help</dev>
                            </li>
                        </nav>
                        </div>
                    </div>
                    <div className="col-lg-3 col-md-6">
                        ...
                        <nav className="list-unstyled">
                        <li className="list-space">
                            <dev href className="list-menu">Real Time Analytic</dev>
                        </li>
                        <li className="list-space">
                            <dev href className="list-menu">Easy to Operate</dev>
                        </li>
                        <li className="list-space">
                            <dev href className="list-menu">Full Secured</dev>
                        </li>
                        <li className="list-space">
                            <dev href className="list-menu">Analytic Tool</dev>
                        </li>
                        <li className="list-space">
                            <dev href className="list-menu">Story</dev>
                        </li>
                        </nav>
                    </div>
                    <div className="col-lg-3 col-md-6">
                        ...
                        <nav className="list-unstyled">
                        <li className="list-space">
                            <dev href className="list-menu">Contact Us</dev>
                        </li>
                        <li className="list-space">
                            <dev href className="list-menu">Blog</dev>
                        </li>
                        <li className="list-space">
                            <dev href className="list-menu">Culture</dev>
                        </li>
                        <li className="list-space">
                            <dev href className="list-menu">Security</dev>
                        </li>
                        </nav>
                    </div>
                    <div className="col-lg-3 col-md-6">
                        ...
                        <nav className="list-unstyled">
                        <li className="list-space">
                            <dev href className="list-menu">Getting Started</dev>
                        </li>
                        <li className="list-space">
                            <dev href className="list-menu">Help Center</dev>
                        </li>
                        <li className="list-space">
                            <dev href className="list-menu">Server Status</dev>
                        </li>
                        </nav>
                    </div>
                    </div>
                ...
                <div className="border-color info-footer">
                    ...
                    <nav className="mx-auto d-flex flex-wrap align-items-center justify-content-center gap-4">
                        <dev href className="footer-link" style={{textDecoration: 'none'}}>Terms of Service</dev>
                        <span>|</span>
                        <dev href className="footer-link" style={{textDecoration: 'none'}}>Privacy Policy</dev>
                        <span>|</span>
                        <dev href className="footer-link" style={{textDecoration: 'none'}}>Licenses</dev>
                    </nav>
